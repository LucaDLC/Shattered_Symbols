local USDDC = RegisterMod("Upside Down Deck of Cards", 1)
local game = Game()
...
function USDDC:useUpsideDownDeckCard()
...
USDDC:AddCallback(ModCallbacks.MC_USE_ITEM, USDDC.useUpsideDownDeckCard, itemID)

-- Imposta l'item con 6 cariche
USDDC:AddCallback(ModCallbacks.MC_POST_PLAYER_INIT, function(_, player)
