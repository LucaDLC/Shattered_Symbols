...
if EID then
    ...
    EID:addCollectible(TornHookLocalID, "{{BrokenHeart}} Gives 1 Broken Hearts at every Floor #Every floor you have 20% of chance (+10% for each Torn Hook after first) of spawn Death Certificate #Jacob and Esau have +10% chance and both have their own percent")
end
