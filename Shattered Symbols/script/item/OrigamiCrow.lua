...
if EID then
    EID:addCollectible(OrigamiCrowLocalID, "{{ArrowUp}} Moves the active item to the pocket item if you don't have one #{{ArrowUp}} If you have no active item, the first one you pick becomes the pocket item #{{BrokenHeart}} Gives 2 Broken Hearts which replaces Hearts in this order {{Heart}}{{BoneHeart}}{{SoulHeart}}{{BlackHeart}}")
end
