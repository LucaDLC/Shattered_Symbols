...
function ShatteredSymbols:havingUnstableGlyph(pickup, collider)
...
ShatteredSymbols:AddCallback(ModCallbacks.MC_PRE_PICKUP_COLLISION, ShatteredSymbols.havingUnstableGlyph)
