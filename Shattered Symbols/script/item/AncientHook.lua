...
function ShatteredSymbols:useAncientHook()
    for playerIndex = 0, game:GetNumPlayers() - 1 do
        ...
        if player:HasCollectible(AncientHookLocalID) then
            ...
            AncientHookChance = AncientHooksCounter * 0.02
