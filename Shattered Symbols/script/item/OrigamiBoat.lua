...
if EID then
    EID:addCollectible(OrigamiBoatLocalID, "{{BrokenHeart}} Every Broken Heart grants:#{{DamageSmall}} +0.7 Damage#{{SpeedSmall}} +0.3 Speed#{{RangeSmall}} +0.6 Range#{{TearsSmall}} +0.6 Tears#{{LuckSmall}} +0.5 Luck")
end

local statMultiplier = {
    damage = 0.7,  -- +0.7 Damage 
    speed = 0.3,   -- +0.3 Speed 
    range = 24,    -- +0.6 Range 
    tears = 0.6,   -- +0.6 Fire Rate
    luck = 0.5,    -- +0.5 Luck 
}
