...
if EID then
    EID:addCollectible(OrigamiBoatLocalID, "{{BrokenHeart}} Every Broken Heart grants:#{{DamageSmall}} +0.7 Damage#{{SpeedSmall}} +0.2 Speed#{{RangeSmall}} +0.5 Range#{{TearsSmall}} +0.5 Tears#{{LuckSmall}} +0.5 Luck")
end
