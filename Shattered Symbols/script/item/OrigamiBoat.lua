...
if EID then
    EID:addCollectible(OrigamiBoatLocalID, "{{BrokenHeart}} Every Broken Heart grants:#{{Damage}} Damage +0.6#{{Speed}} Speed +0.2#{{Range}} Range +0.5#{{Tears}} Tears +0.5#{{Luck}} Luck +0.3")
end
