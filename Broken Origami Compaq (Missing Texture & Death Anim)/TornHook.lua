...
if EID then
    ...
    EID:addCollectible(TornHookLocalID, "{{ArrowDown}} Gives 1 Broken Hearts {{BrokenHeart}} at every Floor #Every floor you have 20% of chance (+10% for each Torn Hook after first) of spawn Wriggling Shadow #Jacob and Esau have +10% chance and both have their own percent")
end
