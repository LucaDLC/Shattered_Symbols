...
function BrokenOrigami:useOrigamiBat(player)
...
function BrokenOrigami:onTearDamageOrigamiBat(entity, damageAmount, damageFlags, source, countdownFrames)
...
function BrokenOrigami:onEvaluateCacheOrigamiBat(player, cacheFlag)
    local data = player:GetData()
...
BrokenOrigami:AddCallback(ModCallbacks.MC_POST_PEFFECT_UPDATE, BrokenOrigami.useOrigamiBat)
BrokenOrigami:AddCallback(ModCallbacks.MC_ENTITY_TAKE_DMG, BrokenOrigami.onTearDamageOrigamiBat)
BrokenOrigami:AddCallback(ModCallbacks.MC_EVALUATE_CACHE, BrokenOrigami.onEvaluateCacheOrigamiBat)
