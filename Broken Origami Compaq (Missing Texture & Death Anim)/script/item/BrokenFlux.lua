...
if EID then
    EID:addCollectible(BrokenFluxLocalID, "{{Warning}} SINGLE USE {{Warning}} #{{UltraSecretRoom}} Teleport in Ultra Secret Room #{{BrokenHeart}} When you hold the item, after gaining Broken Heart, the item remove it for charging, every Broken Heart is equal to one charge #If the absorbed Broken Hearts have replaced Heart, these are not returned #{{ArrowUp}} All Broken Flux of a player share charges during the game ")
end
