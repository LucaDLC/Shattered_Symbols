local origamiBoat = RegisterMod("Origami Boat", 1)
local game = Game()
...
function origamiBoat:onItemPickup(player)
...
function origamiBoat:onEvaluateCache(player, cacheFlag)
...
origamiBoat:AddCallback(ModCallbacks.MC_POST_PEFFECT_UPDATE, origamiBoat.onItemPickup)
origamiBoat:AddCallback(ModCallbacks.MC_EVALUATE_CACHE, origamiBoat.onEvaluateCache)
