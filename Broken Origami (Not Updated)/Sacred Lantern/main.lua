...
--EID
if EID then
    EID:addCollectible(itemID, "{{ArrowUp}} Remove all your broken hearts {{BrokenHeart}} for the rest of the game#For every broken heart {{BrokenHeart}} removed or gain during the rest of the game you obtain:#{{HalfSoulHeart}} Half Soul Heart#{{ColorRed}}It's not cumulative with other Sacred Lanterns{{CR}}")
end
